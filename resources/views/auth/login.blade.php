                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nv_taiKhoan" type="nv_taiKhoan" class="form-control" name="nv_taiKhoan" value="{{ old('nv_taiKhoan') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('nv_matKhau') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nv_matKhau" type="nv_matKhau" class="form-control" name="nv_matKhau" required>
