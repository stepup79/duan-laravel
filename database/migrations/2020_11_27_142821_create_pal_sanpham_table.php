...
class CreatePalSanphamTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pal_sanpham', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            ...
            $table->string('sp_hinh', 191)->comment('Hình đại diện # Hình đại diện của sản phẩm');
        ...
        DB::statement("ALTER TABLE `pal_sanpham` comment 'Sản phẩm # Sản phẩm: hoa, giỏ hoa, vòng hoa, ...'");
    }
    ...
    {
        Schema::dropIfExists('pal_sanpham');
    }
}
