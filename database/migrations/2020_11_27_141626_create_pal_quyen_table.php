...
class CreatePalQuyenTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pal_quyen', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            ...
            $table->string('q_dienGiai', 191)->comment('Diễn giải # Diễn giải về quyền');
